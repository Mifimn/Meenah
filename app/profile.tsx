...
export default function ProfileScreen() {
  ...
  // Track scrolling to power the GlassHeader
    ...
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      >
        ...
        <View style={styles.profileHeader}>
          ...
          <Text style={[styles.userName, { color: theme.text }]}>Ashabi</Text>
          <Text style={[styles.userTier, { color: theme.icon }]}>VIP Member</Text>
          
          {/* --- UPDATED: 10-DIGIT MEMBER ID --- */}
          <View style={[styles.idBadge, { backgroundColor: theme.surface }]}>
            <ShieldCheck size={14} color={theme.primary} />
            <Text style={[styles.idText, { color: theme.text }]}>ID: MH84729105</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  userName: { fontSize: 28, fontWeight: '900', marginBottom: 4 },
